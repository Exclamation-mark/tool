...
public class ChatItemView extends LinearLayout {
    ...
    private BubbleImageView chatPictureLeft;
    ...
    private BubbleImageView chatPictureRight;
...
//                .into(view);
    ...
    private void initView() {
        ...
        chatPictureLeft = (BubbleImageView) findViewById(R.id.chatPictureLeft);
    ...
    private void initData() {
        ...
        switch (MessageType){
            ...
            case voiceLeft:
                ...
                if (listener!= null){
                    playLeft.setOnClickListener(new OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            listener.OnPlayButtonClickedListener(view);
                        }
                    });
                    photoLeft.setOnClickListener(new OnClickListener() {
                        @Override
            ...
            case voiceRight:
                ...
                if (listener!= null){
                    playRight.setOnClickListener(new OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            listener.OnPlayButtonClickedListener(view);
                        }
        ...
        switch (nicknameConfigure){
            case noShowEvery:
                ...
                nicknameRight.setVisibility(INVISIBLE);
                break;
            case showLeft:
